...
export default function Dashboard() {
  ...
  const noApplications = applications.every(
    (inst) => (inst.applications || []).length === 0,
  );
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <section className="mb-5">
            ...
            {isAccepted && (
              <div className="row">
                {loadingApps && (
                  <div className="col-md-12">Loading applications...</div>
                )}
                        ...
                        <div className="card-body p-0">
                          <table className="table table-striped mb-0">
                            <tbody>
                              ...
                              <tr>
                                <th>Price</th>
                                <td className="text-muted">Rp {inst.price}</td>
                              </tr>
                              <tr>
                                <th>Installment</th>
                                <td className="text-muted">
                                  {app.month} Months
                                  <span
                                    className={`${badgeClass(app.apply_status)} ml-2`}
                                  >
                                    {app.apply_status}
                                  </span>
                                </td>
      ...
      <footer>
        <div className="container">
          <div className="text-center py-4 text-muted">Copyright © 2026</div>
        </div>
      </footer>
    </>
  );
